const mockProfiles = [
  ...
  },
  {
    ...
    bio: "HR manager focused on people and culture.",
    status: "💬 Just completed a wellness workshop",
  ...
  },
  {
    ...
    department: "Product",
    location: "Austin",
    bio: "Product manager passionate about agile UX.",
    status: "🧠 Brainstorming for the next sprint",
    interests: "UX, Agile",
...
const mockChatHistory = {
  ...
  "carol@company.com": [
    { sender: "user", text: "Your wellness tips were awesome!" },
    { sender: "friend", text: "Thank you! Glad it helped." }
  ],
  "daniel@company.com": [
    { sender: "friend", text: "Ready for the sprint?" },
    { sender: "user", text: "Absolutely. Let’s do it!" }
  ]
};
